...
toporobot2survex: main.o functions.o toporobot_reader.o container.o survex_writer.o
...
toporobot_reader.o: toporobot_reader.c toporobot_reader.h functions.c container.h
